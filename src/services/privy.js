...
class PrivyService {
    ...
    try {
      ...
      if (isImported && encryptedData) {
        ...
        try {
          ...
          // Create provider for ETH Sepolia
        ...
        return {
          ...
          sendTransaction: async (transaction) => {
            ...
            const privyTransaction = {
              ...
              chain_id: transaction.chainId || 421614 // ETH Sepolia Testnet
            };
            ...
            return await this.client.walletApi.ethereum.sendTransaction({
              walletId: privyWalletId,
              caip2: 'eip155:421614', // Required: ETH Sepolia Testnet
  ...
  async sendTransaction(userWallet, toAddress, amountInArb) {
    try {
      logger.info(`Privy sendTransaction: ${amountInArb} ETH to ${toAddress}`);
      ...
      const { ethers } = require('ethers');
      const amountInWei = ethers.utils.parseEther(amountInArb.toString());
      ...
      const transaction = {
        ...
        chain_id: 421614 // ETH Sepolia Testnet
      };
      ...
      const result = await this.client.walletApi.ethereum.sendTransaction({
        ...
        caip2: 'eip155:421614', // ETH Sepolia Testnet
        transaction: transaction
      });
