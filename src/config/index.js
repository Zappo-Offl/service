...
const config = {
  ...
  whatsapp: {
    sessionPath: './auth/auth_info.json',
  ...
  thirdweb: {
    ...
    rpcUrl: 'https://sepolia-rollup.arbitrum.io/rpc' // Arbitrum Sepolia Testnet RPC
  },
  
  // Testnet URLs
  testnet: {
    faucetUrl: process.env.FAUCET_URL || 'https://arbitrum.faucet.dev/ArbSepolia',
...
config.urls = {
  faucet: 'https://arbitrum.faucet.dev/ArbSepolia',
