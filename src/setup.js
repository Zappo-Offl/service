...
console.log('🚀 ZAPPO WhatsApp ETH Wallet Bot - Setup\n');
...
async function setup() {
  try {
    ...
    // Create .env file
    const envContent = `# ZAPPO WhatsApp ETH Wallet Bot - Environment Configuration
...
# Optional: Custom RPC URL for ETH Sepolia
