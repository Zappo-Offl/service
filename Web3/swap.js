...
async function swapUSDCtoWETH(usdcAmount) {
    try {
        ...
        console.log(`💳 Your USDC balance: ${ethers.formatUnits(balance, USDC.decimals)} USDC`);
        
        if (balance < amountIn) {
            throw new Error(`Insufficient USDC balance! Need ${usdcAmount}, have ${ethers.formatUnits(balance, USDC.decimals)}`);
        }
        ...
        console.log(`📊 Quote: ${ethers.formatUnits(amountOut, WETH.decimals)} WETH`);
        ...
        console.log(`💰 USDC: ${ethers.formatUnits(newUSDCBalance, USDC.decimals)}`);
        console.log(`💰 WETH: ${ethers.formatUnits(newWETHBalance, WETH.decimals)}`);
